...
public class MonographGLTest {
    ...
    public void testEditMonograph(){
        ...
        webDriver.findElement(By.xpath("//div[@id='scientificResearch_tabs']//div[@class='tabs-wrap']//ul[@class='tabs']//li[6]//a//span[2]")).click();

        webDriver.findElement(By.xpath("//div[@id='Monograph_tab']//div[@class='datagrid-body']//tr[@datagrid-row-index='0']")).click();

        webDriver.findElement(By.xpath("//a[@id='Monograph_edit_btn']")).click();
