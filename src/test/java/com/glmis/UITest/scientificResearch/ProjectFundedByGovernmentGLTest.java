 ...
 */
public class ProjectFundedByGovernmentGLTest {
    ...
    public void testEditProjectFundedByGovernment(){
        ...
        webDriver.findElement(By.xpath("//div[@id='scientificResearch_tabs']//div[@class='tabs-wrap']//ul[@class='tabs']//li[2]//a//span[2]")).click();

        webDriver.findElement(By.xpath("//div[@id='ProjectFundedByGovernment_tab']//div[@class='datagrid-body']//tr[@datagrid-row-index='0']")).click();
