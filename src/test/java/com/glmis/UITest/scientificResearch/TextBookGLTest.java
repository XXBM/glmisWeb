...
public class TextBookGLTest {
    ...
    public void testEditTextBook(){
        ...
        webDriver.findElement(By.xpath("//div[@id='scientificResearch_tabs']//div[@class='tabs-wrap']//ul[@class='tabs']//li[5]//a//span[2]")).click();

        webDriver.findElement(By.xpath("//div[@id='TextBook_tab']//div[@class='datagrid-body']//tr[@datagrid-row-index='0']")).click();
