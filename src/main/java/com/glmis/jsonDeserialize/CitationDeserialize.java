 ...
 */
public class CitationDeserialize extends JsonDeserializer<Citation> {
    @Override
    public Citation deserialize(JsonParser jp, DeserializationContext context)
            ...
            if(id==0){
                ...
                return new Citation(citationId);//没获取到id就返回空
            }else {
            return new Citation(id);//有id就返回一个对象
            }
    }
}