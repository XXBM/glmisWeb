 ...
 */
public class EmploymentCategoryDeserialize extends JsonDeserializer<EmploymentCategory> {
    @Override
    public EmploymentCategory deserialize(JsonParser jp, DeserializationContext context)
            ...
            if(id==0){
                ...
                return new EmploymentCategory(id);
            }//返回一个对象
    }
}