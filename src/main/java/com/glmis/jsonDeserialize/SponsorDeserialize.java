 ...
 */
public class SponsorDeserialize extends JsonDeserializer<Sponsor> {
    @Override
    public Sponsor deserialize(JsonParser jp, DeserializationContext context)
            ...
            return new Sponsor(id);//有id就返回一个对象
            }
    }
}