 ...
 */
public class PrivateLeaveDescriptionDeserialize extends JsonDeserializer {
    @Override
    public Object deserialize(JsonParser p, DeserializationContext ctxt) throws IOException, JsonProcessingException {
        ...
        if(id==0){
            ...
            return new PrivateLeaveDescription(textbookRankId);//没获取到id就返回空
        }else {
            return new PrivateLeaveDescription(id);//有id就返回一个对象
        }
    }
}
