 ...
 */
public class AcademicDegreeDeserialize extends JsonDeserializer<AcademicDegree> {
    @Override
    public AcademicDegree deserialize(JsonParser jp, DeserializationContext context)
            ...
            return new AcademicDegree(id);//有id就返回一个对象
            }
    }
}