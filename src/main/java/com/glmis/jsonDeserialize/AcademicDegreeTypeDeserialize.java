 ...
 */
public class AcademicDegreeTypeDeserialize extends JsonDeserializer<AcademicDegreeType> {
    @Override
    public AcademicDegreeType deserialize(JsonParser jp, DeserializationContext context)
            ...
            return new AcademicDegreeType(id);//有id就返回一个对象
            }
    }
}