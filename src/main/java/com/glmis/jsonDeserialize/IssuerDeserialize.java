 ...
 */
public class IssuerDeserialize extends JsonDeserializer<Issuer> {
    @Override
    public Issuer deserialize(JsonParser jp, DeserializationContext context)
            ...
            return new Issuer(id);//有id就返回一个对象
            }
    }
}