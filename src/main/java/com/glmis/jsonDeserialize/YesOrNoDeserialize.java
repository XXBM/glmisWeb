 ...
 */
public class YesOrNoDeserialize extends JsonDeserializer<YesOrNo> {
    @Override
    public YesOrNo deserialize(JsonParser jp, DeserializationContext context)
