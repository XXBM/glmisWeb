 ...
 */
public class TextbookRankDeserialize extends JsonDeserializer<TextbookRank> {
    @Override
    public TextbookRank deserialize(JsonParser jp, DeserializationContext context)
            ...
            if(id==0){
                ...
                return new TextbookRank(textbookRankId);//没获取到id就返回空
            }else {
            return new TextbookRank(id);//有id就返回一个对象
            }
    }
}