 ...
 */
public class ReviewResultDeserialize extends JsonDeserializer<ReviewResult> {
    @Override
    public ReviewResult deserialize(JsonParser jp, DeserializationContext context)
            ...
            return new ReviewResult(id);//有id就返回一个对象
            }
    }
}