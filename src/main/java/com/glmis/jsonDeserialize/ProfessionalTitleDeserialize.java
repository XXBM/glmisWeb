 ...
 */
public class ProfessionalTitleDeserialize extends JsonDeserializer<ProfessionalTitle> {
    @Override
    public ProfessionalTitle deserialize(JsonParser jp, DeserializationContext context)
            ...
            return new ProfessionalTitle(id);//有id就返回一个对象
            }
    }
}