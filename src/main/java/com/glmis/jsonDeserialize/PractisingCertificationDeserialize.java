 ...
 */
public class PractisingCertificationDeserialize extends JsonDeserializer<PractisingCertification> {
    @Override
    public PractisingCertification deserialize(JsonParser jp, DeserializationContext context)
            ...
            return new PractisingCertification(id);//有id就返回一个对象
            }
    }
}