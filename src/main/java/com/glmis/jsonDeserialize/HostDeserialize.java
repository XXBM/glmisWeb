 ...
 */
public class HostDeserialize extends JsonDeserializer<Host> {
    @Override
    public Host deserialize(JsonParser jp, DeserializationContext context)
