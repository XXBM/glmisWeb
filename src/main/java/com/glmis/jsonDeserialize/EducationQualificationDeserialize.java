 ...
 */
public class EducationQualificationDeserialize extends JsonDeserializer<AbstractCategory> {
    @Override
    public EducationQualification deserialize(JsonParser jp, DeserializationContext context)
            ...
            return new EducationQualification(id);//有id就返回一个对象
            }
    }
}